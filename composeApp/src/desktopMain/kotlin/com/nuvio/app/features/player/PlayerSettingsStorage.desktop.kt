...
internal actual object PlayerSettingsStorage {
    ...
    actual fun saveNvidiaRtxSuperResolutionScale(scale: Int) = saveInt(nvidiaRtxSuperResolutionScaleKey, scale)
    actual fun loadNvidiaRtxVideoHdrEnabled(): Boolean? = loadBoolean(nvidiaRtxVideoHdrEnabledKey)
    actual fun saveNvidiaRtxVideoHdrEnabled(enabled: Boolean) = saveBoolean(nvidiaRtxVideoHdrEnabledKey, enabled)
